...
public class ItmVO extends DTO {
	private String itm_id;		//소제목 아이디(P-KEY)
	private String itm_form_id;	//항목 아이디
	 ...
	 * @param itm_use_yn
	 */
	public ItmVO(String itm_id, String itm_form_id, String itm_prd_id, String itm_title, String itm_content,
	...
	public String toString() {
		return "ItmVO [itm_id=" + itm_id + ", itm_form_id=" + itm_form_id + ", itm_prd_id=" + itm_prd_id
