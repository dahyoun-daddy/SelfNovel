package com.sn.user.naverlogin;
...
import com.sn.user.naverlogin.NaverLoginApi;
import com.sn.user.naverlogin.NaverProfileResponse;
import com.sn.user.naverlogin.NaverUser;

public class NaverLoginBO {

	private final static String CLIENT_ID = "KohD8sjB6zl3Ue8J49uV";
	private final static String CLIENT_SECRET = "YFnyTxX2IS";
	private final static String REDIRECT_URI = "http://localhost:8080/controller/user/naver_callback.do";
